# Terraform modules for creating ingress on AWS (Load balancers, certificates, DNS records)
> [!IMPORTANT]
...
The repository contains the following modules simplifying managing DNS entries.
...
```hcl
module "ingress" {
  source = "git::https://github.com/dmfigol/terraform-aws-ingress.git//src/ingress?ref=main"
